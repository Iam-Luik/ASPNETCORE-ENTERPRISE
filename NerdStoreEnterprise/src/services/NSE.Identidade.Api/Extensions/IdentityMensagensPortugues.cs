...
public class IdentityMensagensPortugues : IdentityErrorDescriber
{
    ...
    public override IdentityError InvalidUserName(string userName)
    {
        return new IdentityError
        {
            ...
            Description = $"O login '{userName}' é inválido,pode conter apenas letras ou digitos"
        };
    }
    ...
    {
        return new IdentityError
            { Code = nameof(DuplicateRoleName), Description = $"A permissão '{role}' já está sendo utlizada." };
    }
    ...
    public override IdentityError PasswordRequiresNonAlphanumeric()
    {
        return new IdentityError
        {
            ...
            Description = $"As senhas devem conter ao menos um caractere alfanumérico."
        };
    }
    ...
    public override IdentityError PasswordRequiresLower()
    {
        return new IdentityError
        {
            ...
            Description = $"As senhas devem conter ao menos um caractere em minúsculo."
        };
    }
    ...
    public override IdentityError PasswordRequiresUpper()
    {
        return new IdentityError
        {
            ...
            Description = $"As senhas devem conter ao menos um caractere em maiúsculo."
        };
    }
}